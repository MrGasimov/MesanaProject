...
/**This class is a custom comparator for ordering two objects by priority.Ordering is accomplished as low, medium and high.  
 * @author Suleyman Gasimov
 */
public class LowFilter implements Comparator<Measurement>
{
	
	private final String highOrder = "LOWMEDIUMHIGH";
